<?php
/**
 * Copyright notice. This Class belongs to mtownsend/array-redactor.
 * See https://github.com/mtownsend5512/array-redactor for more details.
 * Since I could not extends the Test, I need to duplicate it here.
 */

namespace TobyMaxham\ArrayFakerRedactor\Test;

use PHPUnit\Framework\TestCase;
use TobyMaxham\ArrayFakerRedactor\ArrayFakerRedactor as ArrayRedactor;

/**
 * @author Tobias Maxham <git2019@maxham.de>
 */
class BaseArrayRedactorTest extends TestCase
{
    protected $content;
